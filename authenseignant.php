...
<form  method="GET" action="infoenseignant.php">
<h3>Cher Enseignant veuillez saisir votre matricule :<input type="text" name="matricule"/></h3>
...

{
    ...
    $req = $bdd->prepare('SELECT nom FROM enseignant WHERE matricule = ?');
